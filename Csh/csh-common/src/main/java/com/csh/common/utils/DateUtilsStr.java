...
public class DateUtilsStr {
    ...
    public static Date dateAdd(Date date, int days, boolean includeTime) throws ParseException{
        ...
        if(!includeTime){
            SimpleDateFormat sdf = new SimpleDateFormat(DateUtilsStr.DATE_PATTERN);
    ...
    public static String dateFormat(Date date, String pattern){
        ...
        if(pattern!=null && !pattern.equals("")){
            pattern = DateUtilsStr.DATE_TIME_PATTERN;
        }
    ...
    public static Date dateParse(String dateTimeString, String pattern) {
        if(dateTimeString!=null && !dateTimeString.equals("")){
            pattern = DateUtilsStr.DATE_PATTERN;
        }
        SimpleDateFormat sdf = new SimpleDateFormat(pattern);
        Date myDate=null;
        try {
            myDate=sdf.parse(dateTimeString);
     ...
     * @throws ParseException
     */
    public static Date dateStrUtils(String dateTimeString, String pattern) {
        if(dateTimeString!=null && !dateTimeString.equals("")){
            pattern = DateUtilsStr.DATE_TIME_PATTERN;
        }
        SimpleDateFormat sdf = new SimpleDateFormat(pattern);
    ...
    public static String dateTimeToDateString(Date dateTime) throws ParseException{
        String dateTimeString = DateUtilsStr.dateFormat(dateTime, DateUtilsStr.DATE_TIME_PATTERN);
